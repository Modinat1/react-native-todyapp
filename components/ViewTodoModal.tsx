      ...
      <View className="flex-row justify-between items-center">
        <View className="flex-row items-center gap-5 my-3">
          ...
          >
            <CommentSvg
              color={
                activeIcon === "comment" ? colors.primary.DEFAULT : "#A0AAB8"
              }
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => setActiveIcon("bag")}>
            <BagSvg
              color={activeIcon === "bag" ? colors.primary.DEFAULT : "#A0AAB8"}
            />
          </TouchableOpacity>
          ...
          >
            <CalenderSvg
              color={
                activeIcon === "calender" ? colors.primary.DEFAULT : "#A0AAB8"
              }
            />
          </TouchableOpacity>
          ...
          >
            <TimeSvg
              color={activeIcon === "time" ? colors.primary.DEFAULT : "#A0AAB8"}
            />
          </TouchableOpacity>
          ...
          >
            <FlagSvg
              color={activeIcon === "flag" ? colors.primary.DEFAULT : "#A0AAB8"}
            />
          </TouchableOpacity>
        </View>
        <View>
